# RockScout Tutorial Video — Narration Script

**Target runtime:** 7:30–9:55
**Voice:** Morgan Freeman cadence — calm, measured, deep, warm authority. Words in the creator's voice: casual, direct, contractions, dry humor deadpan, never a laugh.
**Language:** English (source for translation into 7+ additional languages)

---

## Chapter 1 — Welcome (~20s)
...
## Chapter 5 — Dig Sites & Gem Shows (~30s)
...
## Chapter 7 — Trading & Community (~55s)
...
## Chapter 9 — Aurora & Night Sky (~45s)
...
## Chapter 11 — Reference Library (~45s)
...
## Chapter 12 — Artifacts & Wonders (~30s)
...
## Chapter 15 — Premium & Free Tier (~50s)

...
export const SITE = {
  ...
  description:
    "RockScout is the field companion for rockhounds — AI rock & mineral identification powered by a 5-source system, a 900+ specimen database, dig-site maps, a collection tracker, a trip planner, an aurora forecaster, a Share-a-Spot deep-link tool, and a moderated community of hunters and traders.",

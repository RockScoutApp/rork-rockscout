...
const NotFound = () => (
  <Layout title="Page not found" noIndex>
    <section className="mx-auto flex max-w-xl flex-col items-center px-4 py-16 text-center sm:px-6 sm:py-24 md:py-32">
      <div className="relative">
        <span className="text-6xl font-bold tracking-tight text-primary/30 sm:text-7xl">404</span>
        <span className="absolute inset-0 -z-10 blur-3xl bg-primary/10" aria-hidden />
      </div>
      <h1 className="mt-4 text-xl font-bold tracking-tight sm:text-2xl md:text-3xl">This vein ran out</h1>

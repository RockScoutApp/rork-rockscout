-- RockScout clean migration apply
-- Drops all RockScout tables except rockscout_profiles and specimen_catalog, then recreates them.
...
-- === 0001_rockscout_social_schema.sql ===
...
-- === 0002_rls_tightening_and_indexes.sql ===
...
-- === 0005_pwa_field_journal_trips_favorites.sql ===
...
-- === 0006_pwa_payments_tokens_push.sql ===
...
-- === 0008_pwa_field_captures_saved_images.sql ===
...
-- === 0023_device_platform_column.sql ===

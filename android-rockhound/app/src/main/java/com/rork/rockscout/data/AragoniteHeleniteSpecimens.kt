...
object AragoniteHeleniteSpecimens {
    val specimens: List<Specimen> = listOf(
        ...
        Specimen(
            ...
            formation = "Helenite is created by collecting volcanic ash from the 1980 eruption of Mount St. Helens and melting it at high temperatures with added metal oxides (especially copper and chromium) to produce a vivid green glass. The May 18, 1980 eruption began at 8:32 a.m. PDT with a 5.1 magnitude earthquake that triggered a massive landslide and lateral blast, removing about 1,300 feet (400 m) from the mountain's summit and sending ash across 11 U.S. states and parts of Canada. Volcanic activity continued, and on April 10, 1981 a second explosive eruption occurred, sending an ash column to about 40,000 feet and creating a new crater. The 1981 eruption was smaller than the 1980 event but still a dramatic reminder that the volcano remained active. The glass made from this ash is sold as a wearable reminder of the mountain's power and geological story.",

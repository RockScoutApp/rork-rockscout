...
object ArtifactSpecimens {
    ...
    val stoneEffigies: List<Artifact> = listOf(
        Artifact(
            ...
            imageUrl = BASE + "db358da6-cd37-4a46-8eef-c8dce17b3773.png",
        ...
        Artifact(
            ...
            imageUrl = BASE + "6de1ef23-cf79-4f19-8ea1-49fee3a576b5.png",
            whereFound = listOf("Ohio Valley", "Midwest"),
            ...
            funFacts = listOf(
                "The Adena Pipe is the official state artifact of Ohio.",
                "The figure may represent a mythic hero, shaman, or ancestor.",
                "It was found in a mound near Chillicothe, Ohio, in 1901.",
            ),
            tribe = "Early Woodland (Adena culture)",
            timePeriod = "Early Woodland · 1,000–200 BCE",
            addedAtMs = 1_785_200_000_000L,
        ...
        Artifact(
            ...
            emoji = "🗿",
            accentHex = 0xFF6A7A8B,
            imageUrl = BASE + "082f5817-0cc0-442f-accf-4378585ab240.png",
            whereFound = listOf("Eastern", "Midwest", "Ohio Valley"),
            ...
            funFacts = listOf(
                "Hopewell artisans traded exotic stone for effigies hundreds of miles from quarry.",
                "Birds of prey represented the upper world in the Hopewell cosmos.",
                "Some bird effigies were placed in mortuary contexts as guardians.",
            ),
        ...
        Artifact(
            ...
            emoji = "🗿",
            accentHex = 0xFFA86B4A,
            imageUrl = BASE + "83cddde5-0b52-42f4-9072-b591824a3c96.png",
            whereFound = listOf("Southeast", "Mississippian"),
            ...
            funFacts = listOf(
                "The birdman is a central image of the Southeastern Ceremonial Complex.",
                "It appears on shell gorgets, copper plates, and stone sculptures.",
                "The figure may represent the Morning Star or a culture hero.",
            ),
            tribe = "Mississippian / Southeastern Ceremonial Complex",
            timePeriod = "Mississippian · 1,000–1,500 CE",
            addedAtMs = 1_785_200_000_000L,
        ...
        Artifact(
            ...
            imageUrl = BASE + "e3cab3b0-8055-48a2-8204-4072c174bd16.png",
            whereFound = listOf("Eastern", "Midwest", "Southeast"),
            ...
            funFacts = listOf(
                "Bear effigies are found across the Eastern Woodlands in many materials.",
                "Bears were associated with medicine, strength, and healing powers.",
                "Some bear effigies were carried as personal protective charms.",
            ),
            tribe = "Woodland / Mississippian (various)",
        ...
        Artifact(
            ...
            emoji = "🗿",
            accentHex = 0xFF4A6B5A,
            imageUrl = BASE + "8f9b8cc6-95c9-4e37-91ce-81247ccf2b61.png",
            whereFound = listOf("Southeast", "Midwest", "Ohio Valley"),
            ...
            funFacts = listOf(
                "Serpent imagery is common in the Southeastern Ceremonial Complex.",
                "The Great Serpent Mound in Ohio is the largest serpent effigy in the world.",
                "Serpents were linked to water, thunder, and the underworld.",
            ),
            tribe = "Woodland / Mississippian (various)",
            timePeriod = "Woodland–Mississippian · 1,000 BCE–1,500 CE",
            addedAtMs = 1_785_200_000_000L,
        ...
        Artifact(
            ...
            emoji = "🗿",
            accentHex = 0xFF6A7A6A,
            imageUrl = BASE + "7f9ad08d-58cd-4d9f-a10a-eddf36d03d86.png",
            whereFound = listOf("Eastern", "Midwest", "Southeast"),
            ...
            funFacts = listOf(
                "Turtle effigies are found across the Eastern Woodlands in many forms.",
                "In many traditions, the earth rests on the back of a turtle.",
                "Turtle rattles and effigies were common in ceremonial contexts.",
            ),
            tribe = "Woodland / Mississippian (various)",
            timePeriod = "Woodland–Mississippian · 1,000 BCE–1,500 CE",
            addedAtMs = 1_785_200_000_000L,
    ...
    val sections: List<ArtifactSection> = listOf(
        ...
        ArtifactSection(
            ...
            subtitle = "7 carved figures — human, animal, and spirit effigies from Woodland & Mississippian cultures",

...
object PlanetData {
    ...
    val allPlanets: List<PlanetEntry> = listOf(
        PlanetEntry("Mercury", "Terrestrial", 4879, 0.39, 88.0, 0,
            ...
            "-0.4 to +5.5", "Varies (zodiacal)", "Largest crater: Caloris Basin (960 mi). No atmosphere means no weather.",
            MERCURY_URL),
        ...
        PlanetEntry("Mars", "Terrestrial", 6779, 1.52, 687.0, 2,
            ...
            "-2.9 to +1.8", "Varies (zodiacal)", "Olympus Mons: 13.7 miles tall. Polar ice caps. Dust storms can cover the planet.",
            MARS_URL),
        ...
        PlanetEntry("Saturn", "Gas Giant", 116460, 9.58, 10759.0, 146,
            "The ringed jewel of the solar system. Its rings span 173,000 miles but are only ~33 feet thick.",
        ...
        PlanetEntry("Neptune", "Ice Giant", 49244, 30.05, 60190.0, 16,
            "The windiest planet — supersonic winds reach 1,300 mph. Deep blue from methane in its atmosphere.",
            17.1, 11.15, "-218 (cloud tops)", "H₂ (80%), He (19%), CH₄ (1%)", "Opposition (needs telescope)",
            "+7.7 to +8.0", "Varies (zodiacal)", "Supersonic winds (1,300 mph). Great Dark Spot storm. 16 moons including Triton.",
            NEPTUNE_URL),

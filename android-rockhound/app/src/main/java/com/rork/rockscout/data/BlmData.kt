...
object BlmData {
    ...
    val trailheads: List<BlmTrailhead> = listOf(
        ...
        // New Hampshire (previously missing)
        BlmTrailhead("Moat Mountain Trailhead", "NH", "North Conway, New Hampshire", "Access to smoky quartz and feldspar collecting in the White Mountains. White Mountain National Forest — check collecting regulations. Scenic alpine area with pegmatite minerals.", 44.2370, -71.1300),
        // Additional entries for underrepresented states
        BlmTrailhead("Round Mountain Trailhead", "AZ", "Round Mountain, Arizona", "Second BLM-designated rockhound area in eastern Arizona. Collectible minerals and rocks — less visited than Black Hills. Remote desert access.", 33.0720, -109.0850),
        BlmTrailhead("Himalaya Tourmaline Mine Trailhead", "CA", "Mesa Grande, California", "Fee-dig tourmaline mine in San Diego County. World-class pink and green tourmaline, lepidolite, and quartz. Private operation — access by appointment.", 33.1070, -116.8320),
        BlmTrailhead("Petrified Forest Area Trailhead", "CO", "Calhan, Colorado", "Access to petrified wood collecting in the Paint Mines Interpretive Park area. El Paso County park — collecting restricted but surrounding BLM land may yield specimens.", 39.0340, -104.2820),
        BlmTrailhead("Spencer Opal Mine Trailhead", "ID", "Spencer, Idaho", "Fee-dig precious opal mine in the Spencer opal fields. One of the few opal localities in the U.S. Private operation open seasonally.", 44.3680, -112.0450),
        BlmTrailhead("Gravelly Range Trailhead", "MT", "Virginia City, Montana", "Access to agate, jasper, and fossil collecting in the Gravelly Range. BLM and Forest Service land. Scenic backcountry drive.", 45.2780, -112.0240),
        BlmTrailhead("Rainbow Gardens Trailhead", "NV", "Las Vegas, Nevada", "Access to BLM land in the Rainbow Gardens area near Lake Mead. Colorful volcanic rock formations and mineral collecting. Day-use area.", 36.1670, -114.8380),
        BlmTrailhead("Turquoise Trail Trailhead", "NM", "Cerrillos, New Mexico", "Historic turquoise mining district south of Santa Fe. BLM and private land mixed. Old turquoise workings — some surface collecting on BLM portions.", 35.3970, -106.1240),
        BlmTrailhead("Thunderegg Beds Trailhead", "OR", "Prineville, Oregon", "Access to thunderegg collecting areas in central Oregon. BLM land near Prineville — multiple beds require high-clearance vehicle. Oregon's state rock.", 44.2980, -120.8340),
        BlmTrailhead("Dugway Geode Beds Trailhead", "OR", "Dugway, Oregon", "Access to geode beds in the Owyhee Canyonlands. BLM land — remote desert collecting. Bring plenty of water and a high-clearance vehicle.", 43.8420, -117.3040),
        BlmTrailhead("Fairburn Agate Beds Trailhead", "SD", "Fairburn, South Dakota", "Access to Fairburn agate collecting in the Black Hills area. BLM and Forest Service land. Fairburn agate is South Dakota's state gemstone.", 43.6870, -103.8420),
        BlmTrailhead("Bonneville Salt Flats Trailhead", "UT", "Wendover, Utah", "Access to the Bonneville Salt Flats — vast salt crust collecting and geological observation. BLM land. Collecting small salt samples allowed; vehicle access restricted.", 40.7950, -113.8830),
        BlmTrailhead("Copalis Beach Trailhead", "WA", "Copalis Beach, Washington", "Beach collecting for fossils and agates along the Washington coast. State and tribal land mixed — verify boundaries. Razor clam digging area.", 47.1150, -124.1830),
        BlmTrailhead("Madagascar Agate Area Trailhead", "WY", "Guernsey, Wyoming", "Access to agate and chert collecting along the North Platte River. BLM land near Guernsey State Park. Also petrified wood in the area.", 42.6780, -104.7420),
        BlmTrailhead("Chattanooga Valley Trailhead", "AL", "Chattanooga Valley, Alabama", "Access to hematite and fossils in the Lookout Mountain area. State and private land mixed — some road cuts yield specimens. Alabama's Appalachian foothills.", 34.5620, -85.3780),
        BlmTrailhead("Hot Springs Area Trailhead", "AR", "Hot Springs, Arkansas", "Access to quartz crystal collecting in the Ouachita National Forest near Hot Springs. Multiple fee-dig operations in the area. Also wavellite and novaculite.", 34.5030, -93.0550),
        BlmTrailhead("Old Mine Park Trailhead", "CT", "Trumbull, Connecticut", "Historic mineral collecting at Old Mine Park — garnet, tourmaline, and beryl. Town park with surface collecting permitted. Connecticut's best public mineral site.", 41.2580, -73.2250),
        BlmTrailhead("Delaware Bay Fossil Trailhead", "DE", "Dover, Delaware", "Beach and bay collecting for fossils — Cretaceous marine fossils including belemnites and shark teeth. State and private land mixed along the Delaware Bay.", 39.1580, -75.4390),
        BlmTrailhead("Cave Spring Area Trailhead", "GA", "Lafayette, Georgia", "Access to limestone and fossil collecting in northwest Georgia. State and private land — also beryl and quartz in the Appalachian foothills.", 34.7050, -85.2820),
        BlmTrailhead("Hana Coast Trailhead", "HI", "Hana, Maui, Hawaii", "Access to volcanic basalt and olivine along the Hana coast. State and county land — collecting limited. Scenic Road to Hana area.", 20.7700, -155.9910),
        BlmTrailhead("Mississippi River Bluff Trailhead", "IA", "Marquette, Iowa", "Access to fossils and geodes along the Mississippi River bluffs. State and private land — Effigy Mounds area. Ordovician fossils in limestone outcrops.", 43.0410, -91.1810),
        BlmTrailhead("Salem Limestone Belt Trailhead", "IN", "Salem, Indiana", "Access to the famous Salem Limestone belt — fossils in limestone quarries. Private quarries may allow collecting with permission. Also calcite and pyrite.", 38.6040, -86.1750),
        BlmTrailhead("Smoky Hill Chalk Trailhead", "KS", "Quinter, Kansas", "Additional access to the Smoky Hill Chalk badlands for marine fossils. Private land mixed — verify boundaries. Shark teeth, fish vertebrae, and mosasaur fragments.", 39.8510, -100.2380),
        BlmTrailhead("Mammoth Cave Area Trailhead", "KY", "Cave City, Kentucky", "Access to limestone and fossil collecting near Mammoth Cave National Park. State and private land — outside park boundaries. Crinoids and brachiopods in limestone.", 37.1420, -86.0670),
        BlmTrailhead("Kisatchie Agate Trailhead", "LA", "Natchitoches, Louisiana", "Access to petrified palm wood and agate collecting in Kisatchie National Forest. USFS land — also chert and quartzite gravels in the Kisatchie WMA.", 31.7520, -93.0860),
        BlmTrailhead("Deer Isle Trailhead", "ME", "Deer Isle, Maine", "Access to granite and pegmatite minerals on Deer Isle. Private quarries and public shore access — garnet, tourmaline, and beryl. Scenic Penobscot Bay area.", 44.2240, -68.6780),
        BlmTrailhead("Old Mine Trailhead", "MD", "Chestnut Ridge, Maryland", "Access to garnet and kyanite collecting in the western Maryland Piedmont. State and private land mixed — also chromite in the Soldier's Delight area.", 39.3520, -77.0340),
        BlmTrailhead("Newburyport Fossil Trailhead", "MA", "Newburyport, Massachusetts", "Beach collecting for fossils at Plum Island — Cretaceous and Pleistocene fossils. State and federal land — also glacial erratics and interesting minerals in Essex County.", 42.8130, -70.8710),
        BlmTrailhead("Copper Harbor Trailhead", "MI", "Copper Harbor, Michigan", "Additional access to native copper and associated minerals at the tip of the Keweenaw Peninsula. State and private land mixed — also prehnite and calcite.", 47.4680, -87.8840),
        BlmTrailhead("Pipestone National Monument Area Trailhead", "MN", "Pipestone, Minnesota", "Access to pipestone (catlinite) viewing area — collecting prohibited in monument but surrounding lands may yield quartzite and agates. State and private land.", 44.0010, -96.2550),
        BlmTrailhead("Vicksburg Fossil Trailhead", "MS", "Vicksburg, Mississippi", "Access to fossil collecting along the Mississippi River bluffs. State and private land — loess deposits yield Pleistocene fossils. Also petrified wood.", 32.3520, -90.8720),
        BlmTrailhead("Elephant Rocks Trailhead", "MO", "Belleview, Missouri", "Access to the Elephant Rocks State Park area — giant granite boulders. Collecting restricted in park but surrounding Forest Service land may yield specimens.", 37.8540, -90.5980),
        BlmTrailhead("Agate Fossil Beds Trailhead", "NE", "Agate Fossil Beds, Nebraska", "Access to Miocene fossil viewing area. Collecting prohibited in the national monument but surrounding lands may yield agates and fossils. Nebraska's panhandle.", 42.4240, -103.7450),
        BlmTrailhead("Sterling Hill Mine Trailhead", "NJ", "Ogdensburg, New Jersey", "Fee-dig access to the Sterling Hill Mine — world-class fluorescent minerals. Zinc mine with willemite, calcite, and franklinite. Private operation and museum.", 41.0740, -74.5980),
        BlmTrailhead("Adirondack Garnet Trailhead", "NY", "North Creek, New York", "Access to garnet collecting in the Adirondack Mountains. Gore Mountain area — state and private land. New York's state gem is the garnet.", 43.6960, -73.9820),
        BlmTrailhead("Spruce Pine District Trailhead", "NC", "Spruce Pine, North Carolina", "Access to pegmatite minerals — feldspar, mica, quartz, and aquamarine. Private mines offer fee-dig. The Spruce Pine Mining District is world-famous.", 35.9080, -82.0680),
        BlmTrailhead("Theodore Roosevelt Badlands Trailhead", "ND", "Theodore Roosevelt NP area, North Dakota", "Access to petrified wood and lignite in the badlands. Collecting prohibited inside the national park but surrounding BLM and state lands may yield specimens.", 46.9780, -103.5450),
        BlmTrailhead("Serpent Mound Area Trailhead", "OH", "Peebles, Ohio", "Access to Ordovician fossils and flint near the Serpent Mound area. State and private land — also celestite and fluorite in southern Ohio.", 39.0250, -83.4320),
        BlmTrailhead("Barite Rose Rock Trailhead", "OK", "Noble, Oklahoma", "Access to barite rose rock collecting — Oklahoma's state rock. State and private land in central Oklahoma. Rose rocks form in Garber Sandstone.", 35.1340, -97.3920),
        BlmTrailhead("Cornwall Iron Mine Area Trailhead", "PA", "Cornwall, Pennsylvania", "Historic iron mine area — magnetite, hematite, and copper minerals. Private and state land — access via mineral clubs. Also pyrite and quartz nearby.", 40.2720, -76.4050),
        BlmTrailhead("Block Island Trailhead", "RI", "Block Island, Rhode Island", "Beach collecting for quartz pebbles and glacial erratics. State and town land — also fossils in clay cliffs. Scenic island in the Atlantic.", 41.1830, -71.5580),
        BlmTrailhead("Ashaway Fossil Trailhead", "SC", "Ashaway, South Carolina", "Access to Cretaceous fossils and phosphate deposits in western South Carolina. State and private land — also quartz crystals in the Piedmont.", 41.4250, -71.7890),
        BlmTrailhead("Cumberland Plateau Trailhead", "TN", "Crossville, Tennessee", "Access to fossils and agates in the Cumberland Plateau. State and private land — also coal and pyrite. Scenic plateau with waterfalls and gorges.", 35.9050, -85.0280),
        BlmTrailhead("Big Bend Ranch Trailhead", "TX", "Lajitas, Texas", "Access to agate, jasper, and petrified wood in Big Bend Ranch State Park area. State park — some collecting permitted. Also calcite and fluorite.", 29.2590, -103.7830),
        BlmTrailhead("Virginia Gold-Pyrite Belt Trailhead", "VA", "Goldvein, Virginia", "Access to gold and pyrite collecting in Virginia's historic gold-pyrite belt. State and private land — also quartz and garnet. Virginia was a gold-producing state.", 38.4180, -77.3240),
        BlmTrailhead("Belvidere Mountain Trailhead", "VT", "Lowell, Vermont", "Access to asbestos-associated minerals — grossular garnet, diopside, and vesuvianite. Private quarry — access via mineral clubs. Vermont's state mineral.", 44.7930, -72.3450),
        BlmTrailhead("Cranberry Glades Trailhead", "WV", "Hillsboro, West Virginia", "Access to fossils and quartzite in the Monongahela National Forest area. USFS land — also coal and ironstone. Highland bogs and scenic mountains.", 38.1370, -80.3180),
        BlmTrailhead("Prairie du Chien Trailhead", "WI", "Prairie du Chien, Wisconsin", "Access to fossils and lead/zinc minerals in the driftless area. State and private land — Ordovician fossils in limestone outcrops along the Mississippi.", 43.0510, -91.1860),
    )
